 ...
 */
class Version20150723085120 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE student DROP firstName, DROP lastName, DROP role, DROP over12, DROP parentEmail, DROP signupDate');
    }
}
