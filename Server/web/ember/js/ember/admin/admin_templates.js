...
function program3(depth0,data) {
  ...
  },hashTypes:{'data-toggle': "STRING",'href': "STRING",'class': "STRING"},hashContexts:{'data-toggle': depth0,'href': depth0,'class': depth0},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "message.new", options) : helperMissing.call(depth0, "link-to", "message.new", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  ...
  stack1 = helpers.each.call(depth0, "user", "in", "model", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
